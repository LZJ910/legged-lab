...
All the environments are registered in the `leggedlab` extension. They start
...
import leggedlab.tasks  # noqa: F401
from prettytable import PrettyTable


def main():
    """Print all environments registered in `leggedlab` extension."""
